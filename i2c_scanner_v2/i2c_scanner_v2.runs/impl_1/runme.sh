...
HD_PWD='E:/vivado_prj/i2c_scanner_v2/i2c_scanner_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_scan_v2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_scan_v2_wrapper.tcl -notrace
