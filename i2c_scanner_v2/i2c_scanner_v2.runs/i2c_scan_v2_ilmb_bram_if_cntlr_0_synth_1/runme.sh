...
HD_PWD='E:/vivado_prj/i2c_scanner_v2/i2c_scanner_v2.runs/i2c_scan_v2_ilmb_bram_if_cntlr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_scan_v2_ilmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_scan_v2_ilmb_bram_if_cntlr_0.tcl
